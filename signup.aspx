<%@ Page Title="" Language="C#" MasterPageFile="~/Basic.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="Absent_MG.signup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">Sign Up</h1>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <absentel for="name">University Id</absentel>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <asp:TextBox ID="TextBox7" runat="server" CssClass="form-control border-1 rounded-pill w-100 ps-4 pe-5"  placeholder="Name" required></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <asp:Button ID="Button1" runat="server"
                                        Text="Signup" OnClick="Button1_Click" CssClass="btn btn-primary w-100 py-3" />
                                </div>
                                <br />
                                <div class="col-12">
                                    <div class="form-floating">
